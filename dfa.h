...
extern DFA DFA_for_contains_ullman();

extern DFA DFA_for_startsWith_com();

extern DFA DFA_for_contains_threethrees();

extern DFA DFA_for_contains_evenzeros_oddones();

extern void DFA_repl(DFA dfa);

extern void DFA_free(DFA dfa);

extern int getIndex(LinkedList list, IntHashSet set);
